    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center pt-12 gap-8 px-4 md:px-8">
        ...
        <p className='text-lg'>
          ...
          That meaning most of my weight and devolvement time was dedicated towards designing and reinforcing the robots structural components.
          After a few days of on and off testing I had my first reliable drive "module".
          The rectangular design of these test pods inspired me to design the rest of the robot in a similar fashion, relying on modular components that easily drop in and out for maintenance.
        ...
        <p className='text-lg'>
          ...
          Essentially my goal was spend 90% of my time on 10% of the robot.
        ...
        <p className='text-lg'>
          ...
          This made it incredibly easy to swap out motors and esc's if one or both of them failed.
        </p>
        ...
        <p className='text-lg'>
          ...
          And secondly, I needed to switch materials, asa wasn't going to cut it for an application so deaning.
        ...
        <p className='text-lg'>
          ...
          Im currently abroad in Singapore for a the term and have no access to my printer, so I will be unable to make any changes until I return.
