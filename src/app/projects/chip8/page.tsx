    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center pt-12 gap-8 px-4 md:px-8">
        ...
        <p className='text-lg'>
          ...
          After hours of debugging and testing, I isolated the issue into two key areas.
          ...
          This project was my first time using SDL2 and I decided to redraw the entire window for every frame.
